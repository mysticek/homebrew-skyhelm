...
class Skyhelm < Formula
  ...
  url "https://github.com/mysticek/homebrew-skyhelm/releases/download/v0.3.3/skyhelm.tar.gz"
  sha256 "437198ffa04bd453c633b5b71d461226ed18d550e678cec3c623d1a10d0165e4"
  ...
  test do
    assert_match "0.3.3", shell_output("#{bin}/skyhelm --version")
  end
end
